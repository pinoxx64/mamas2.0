  ...
  form.addEventListener('submit', async function (event) {
    ...
    try {
      ...
      if (response.ok && resultado.success) {
        ...
        if (resultado.data.active !== 1) {
          console.warn("El usuario no está activo. No se permite el inicio de sesión.");
          alert("Tu cuenta no está activa. Por favor, contacta al administrador.");
          return;
        }
